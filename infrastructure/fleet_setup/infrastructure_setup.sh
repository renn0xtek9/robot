...
read SHA256 
ansible-playbook -K -i inventory.yaml continuous_integration/charlieindia_setup_runner.yaml -e "target_host=charlieindia1" -e "runner_token=$GH_RUNNER_TOKEN" -e "sha256_github_runner=$SHA256" --ask-pass --ask-become-pass
